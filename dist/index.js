...
const is_response_ok_1 = __webpack_require__(915);
...
const url_to_options_1 = __webpack_require__(235);
...
const processor_1 = __webpack_require__(589);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
class Processor {
    ...
    process() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authenticateResponse = yield got_1.default.post(`${xrayBaseUrl}/api/v1/authenticate`, {
                json: {
            ...
            try {
                for (var _b = __asyncValues(globber.globGenerator()), _c; _c = yield _b.next(), !_c.done;) {
                    ...
                    try {
                        ...
                        const importResponse = yield got_1.default.post(`${xrayBaseUrl}/api/v1/import/execution/junit`, {
                            searchParams,
                            headers: {
